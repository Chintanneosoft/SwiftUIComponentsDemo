        ...
        VStack{
            ...
            Text("On Tap Gesture")
                ...
                .onTapGesture {
                    ...
                    textData = "On Tap Gesture Tapped"
                }
            ...
            Text("On Tap Gesture with Count")
                ...
                .onTapGesture(count: 2) {
                    ...
                    textData = "On Tap Gesture with count Tapped"
                }
//
            Text("On LongPress Gesture with MinimumDuration")
                ...
                .onLongPressGesture(minimumDuration: 2) {
                    ...
                    textData = "On LongPress Gesture with MinimumDuration Tapped"
                }
//
            Text("On LongPress Gesture with Progress")
                .padding()
                .onLongPressGesture {
                    print("On LongPress Gesture with condition Tapped")
                    textData = "On LongPress Gesture with condition Tapped"
                } onPressingChanged: { inProgress in
                    print("Is in Progress \(inProgress)")
                    textData = "On LongPress Gesture with condition Tapped \(inProgress)"
                }
//
